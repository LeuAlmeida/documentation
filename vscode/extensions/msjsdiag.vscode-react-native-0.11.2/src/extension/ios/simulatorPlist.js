...
class SimulatorPlist {
    constructor(projectRoot, scheme, { nodeFileSystem = new fileSystem_1.FileSystem(), plistBuddy = new plistBuddy_1.PlistBuddy(), nodeChildProcess = new childProcess_1.ChildProcess(), } = {}) {
    ...
    findPlistFile(configuration, productName) {
        return Q.all([
            this.plistBuddy.getBundleId(this.projectRoot, true, configuration, productName, this.scheme),
            ...
            return this.nodeFileSystem.readDir(pathBefore).then((apps) => {
                ...
                if (plistCandidates.length === 0) {
                    ...
                    this.logger.warning(errorHelper_1.ErrorHelper.getWarning(localize(0, null)));
                }
