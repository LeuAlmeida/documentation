const config = {
  ...
  sidebar: {
    forcedNavOrder: ["/utils", "/aws", "/introduction", "/javascript", "/typescript", "/nodejs", "/reactjs", "/react-native", "/flux", "/websocket", "/tests"],
    collapsedNav: ["/utils", "/aws", "/introduction", "/javascript", "/typescript", "/nodejs", "/reactjs", "/react-native", "/flux", "/websocket", "/tests"],
    links: [
