...
class TelemetryGeneratorBase {
    constructor(componentName, extendedProps = {}) {
    ...
    sendCurrentStep() {
        ...
        telemetryHelper_1.TelemetryHelper.addTelemetryEventProperties(telemetryEvent, Object.assign(this.telemetryProperties, this.extendedTelemetryProperties));
    ...
    combine(...components) {
        let nonNullComponents = components.filter((component) => !!component);
