...
class WindowsHostPlatform {
    ...
    isCompatibleWithTarget(targetPlatformId) {
        switch (targetPlatformId) {
            case targetPlatformHelper_1.TargetPlatformId.ANDROID:
            case targetPlatformHelper_1.TargetPlatformId.EXPONENT:
            case targetPlatformHelper_1.TargetPlatformId.WINDOWS:
                return true;
            default:
                return false;
        }
...
class OSXHostPlatform extends UnixHostPlatform {
    ...
    isCompatibleWithTarget(targetPlatformId) {
        switch (targetPlatformId) {
            case targetPlatformHelper_1.TargetPlatformId.ANDROID:
            case targetPlatformHelper_1.TargetPlatformId.EXPONENT:
            case targetPlatformHelper_1.TargetPlatformId.IOS:
                return true;
            default:
                return false;
        }
